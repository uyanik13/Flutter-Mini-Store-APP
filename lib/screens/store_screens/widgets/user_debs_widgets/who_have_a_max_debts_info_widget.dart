...
class WhoHaveMaxDebtsInfoBarWidget extends StatelessWidget {
  final AnimationController animationController;
  final Animation animation;

  const WhoHaveMaxDebtsInfoBarWidget({Key key, this.animationController, this.animation})
      : super(key: key);
                              ...
                              ClipRRect(
                                ...
                                child: SizedBox(
                                  ...
                                  child: AspectRatio(
                                    aspectRatio: 1.250,
                                    child: Image.asset(
                                        "assets/images/app/marketim.png"),
                                  ),
                                ),
                              ),
                              Column(
