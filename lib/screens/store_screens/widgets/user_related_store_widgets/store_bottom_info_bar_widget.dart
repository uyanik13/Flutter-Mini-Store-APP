...
class StoreBottomInfoBarWidget extends StatelessWidget {
  final AnimationController animationController;
  final Animation animation;

  const StoreBottomInfoBarWidget({Key key, this.animationController, this.animation})
      : super(key: key);
                        ...
                        children: <Widget>[
                          ...
                          Positioned(
                            ...
                            child: SizedBox(
                              width: 110,
                              height: 110,
                              child: Image.asset("assets/images/app/market.png"),
                            ),
                          )
                        ],
                      ),
