...
class GiftInfoBarWidget extends StatelessWidget {
  final AnimationController animationController;
  final Animation animation;

  const GiftInfoBarWidget({Key key, this.animationController, this.animation})
      : super(key: key);
                    ...
                    children: <Widget>[
                      ...
                      Positioned(
                        ...
                        child: SizedBox(
                          width: 110,
                          height: 110,
                          child: Image.asset("assets/images/app/gift_point.png"),
                        ),
                      )
                    ],
                  ),
