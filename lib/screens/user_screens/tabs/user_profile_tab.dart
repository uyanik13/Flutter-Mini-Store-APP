...
class _ProfileTab extends State<ProfileTab> with SingleTickerProviderStateMixin {
  ...
  chooseImage(BuildContext context) {
    ...
    _userProvider.updateUserImage(context,_authProvider.token,()=> CheckStatusScreen());
    //startUpload(context);
  }
