...
class UserInvoiceItemTab extends StatefulWidget {
  const UserInvoiceItemTab({Key key, this.animationController,this.invoice}) : super(key: key);

  final AnimationController animationController;
  final dynamic invoice;
  @override
  _UserInvoiceItemTab createState() => _UserInvoiceItemTab();
}

class _UserInvoiceItemTab extends State<UserInvoiceItemTab>
